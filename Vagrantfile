...
#  config.ssh.insert_key = false
  ...
  config.vm.define :admin1 do |admin1|
    ...
    admin1.vm.provision :ansible_local do |ansible|
      ...
      # ansible.extra_vars doesn't work
      ansible.raw_arguments = [
        "--extra-vars",
        "maven_repository_manager=http://10.0.2.2:8081/nexus/content/groups/public"
      ]
      ansible.host_vars = ansible_host_vars
    end
    ...
    admin1.vm.provision :ansible_local do |ansible|
      ...
      ansible.limit          = 'node1'
      ansible.provisioning_path = '/home/vagrant/ansible-playbook-fuse'
      ansible.playbook       = '/home/vagrant/ansible-playbook-fuse/fuse-deploy-bundle.yaml'
      ansible.groups = {
        "fuse-vagrant" => ["node1"]
      }
      # ansible.extra_vars doesn't work
